...
x0 = [2000 0 0 70 0.035]';
P0 = diag([500 50 500 50 30]);
...
plot(vUKF_RMSE1(1,T2),vUKF_RMSE1(2,T2),'k-s',vPUKF_RMSE1(1,T2),vPUKF_RMSE1(2,T2),'k-d',vCKF_RMSE1(1,T2),vCKF_RMSE1(2,T2),'k-^',vPCKF_RMSE1(1,T2),vPCKF_RMSE1(2,T2),'k-o');
...
plot(vUKF_RMSE2(1,T2),vUKF_RMSE2(2,T2),'k-s',vPUKF_RMSE2(1,T2),vPUKF_RMSE2(2,T2),'k-d',vCKF_RMSE2(1,T2),vCKF_RMSE2(2,T2),'k-^',vPCKF_RMSE2(1,T2),vPCKF_RMSE2(2,T2),'k-o');
legend('UKF','PUKF','CKF','PCKF');
xlabel('t,s');
ylabel('RMSE,m')
...
plot(vUKF_RMSE3(1,T2),vUKF_RMSE3(2,T2),'k-s',vPUKF_RMSE3(1,T2),vPUKF_RMSE3(2,T2),'k-d',vCKF_RMSE3(1,T2),vCKF_RMSE3(2,T2),'k-^',vPCKF_RMSE3(1,T2),vPCKF_RMSE3(2,T2),'k-o');
legend('UKF','PUKF','CKF','PCKF');
xlabel('t,s');
ylabel('RMSE,m/s')
...
plot(vUKF_RMSE4(1,T2),vUKF_RMSE4(2,T2),'k-s',vPUKF_RMSE4(1,T2),vPUKF_RMSE4(2,T2),'k-d',vCKF_RMSE4(1,T2),vCKF_RMSE4(2,T2),'k-^',vPCKF_RMSE4(1,T2),vPCKF_RMSE4(2,T2),'k-o');
legend('UKF','PUKF','CKF','PCKF');
xlabel('t,s');
ylabel('RMSE,m/s')
