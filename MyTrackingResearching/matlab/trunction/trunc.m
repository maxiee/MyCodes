...
for loop = 1:Loop
    ...
    for i=1:count
        ...
        target_pos_x = origin + cos(i*delta)*radius + randn(1)*0.1;
        target_pos_y = origin + sin(i*delta)*radius + randn(1)*0.1;
...
T = 1:count;
figure;
plot(T,TUKF_RMSE1,T,TCKF_RMSE1);
legend('TUKF','TCKF');
figure;
plot(T,TUKF_RMSE2,T,TCKF_RMSE2);
legend('TUKF','TCKF');
figure;
plot(T,TUKF_RMSE3,T,TCKF_RMSE3);
legend('TUKF','TCKF');
figure;
plot(T,TUKF_RMSE4,T,TCKF_RMSE4);
legend('TUKF','TCKF');
